export default function ContainerDois({ imgSrc, title, description }) {
    return (
        <div style={{ display: 'flex', justifyContent: 'center', padding: '20px', boxSizing: 'border-box' }}>
            <div style={{ display: 'flex', backgroundColor: '#daa520', padding: '20px', boxSizing: 'border-box', alignItems: 'center', maxWidth: 'calc(100% - 100px)', margin: '0 50px', marginLeft:'90px' }}>
